<template>
    <div class="blog">
        ...
        <div class="blog__card" v-for="(card, i) in blogCards" :key="i">
                  <nuxt-link :to="card.link"  class="blog__card__title"> 
        ...
        return {
            blogCards: [
                ...
                },
                {
                    ...
                    date: '2 August 2019',
                    intro:
                        'Using v-for inside a template is pretty common within a Vue app....',
                    link: '/v-for',
                },
                {
